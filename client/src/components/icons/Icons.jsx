...
const CollectionIcon = ({ size, color }) => {
  return (
    <svg role="img" height={size} width={size} viewBox="0 0 24 24">
      <path
...
const PlusIcon = ({ size, color }) => {
  return (
    ...
    >
      <path d="M14 7H9V2H7v5H2v2h5v5h2V9h5z" fill={color}></path>
      <path fill="none" d="M0 0h16v16H0z"></path>
    </svg>
  );
};

const HeartFilledIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const PrevIcon = ({ size, color }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <polyline stroke={color} points="16 4 7 12 16 20" fill="none" />
    </svg>
  );
};
...
const NextIcon = ({ size, color }) => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <polyline stroke={color} points="8 4 17 12 8 20" fill="none" />
    </svg>
  );
};

const DownDirIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path fill={color} d="M3 6l5 5.794L13 6z" />
    </svg>
  );
};

const ExternalIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const PauseIcon = ({ size, color }) => {
  return (
    ...
    >
      <path fill="none" d="M0 0h16v16H0z" />
      <path d="M3 2h3v12H3zm7 0h3v12h-3z" fill={color} />
    </svg>
  );
};

const PlayerPrevIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M13 2.5L5 7.119V3H3v10h2V8.881l8 4.619z" fill={color} />
    </svg>
  );
};

const PlayerNextIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M11 3v4.119L3 2.5v11l8-4.619V13h2V3z" fill={color} />
    </svg>
  );
};

const ShuffleIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const PictureInPictureIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const VolumeMutedIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const VolumeLowIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const VolumeNormalIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const VolumeFullIcon = ({ size, color }) => {
  return (
    <svg
      viewBox="0 0 16 16"
      width={size}
...
const CloseWindowIcon = ({ size, color }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
  ...
  return (
    ...
    >
      <path
        ...
        fill={color}
      />
      <path d="M19 14h-2v3h-3v2h3v3h2v-3h3v-2h-3z" fill={color} />
    </svg>
  );
};
const UserProfile = ({ size, color }) => {
  return (
    ...
    >
      <path d="M12 2C6.579 2 2 6.579 2 12s4.579 10 10 10 10-4.579 10-10S17.421 2 12 2zm0 5c1.727 0 3 1.272 3 3s-1.273 3-3 3c-1.726 0-3-1.272-3-3s1.274-3 3-3zm-5.106 9.772c.897-1.32 2.393-2.2 4.106-2.2h2c1.714 0 3.209.88 4.106 2.2C15.828 18.14 14.015 19 12 19s-3.828-.86-5.106-2.228z" fill={color}></path>
    </svg>
  );
};
